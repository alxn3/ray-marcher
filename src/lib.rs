...
impl State {
    ...
    async fn new(window: &Window) -> Self {
        ...
        let config = wgpu::SurfaceConfiguration {
            ...
            width: size.width,
            height: size.height,
            // TODO: Allow user to change this render mode. Fifo is basically VSync.
    ...
    fn resize(&mut self, new_size: winit::dpi::PhysicalSize<u32>) {
        // Doesn't actually do anything on web, CSS taking care of that.
...
pub async fn run() {
    ...
    #[cfg(target_arch = "wasm32")]
    {
        ...
        // Can ignore this if we force canvas to resize.
